...
food_orders = pd.read_csv("C:/Users/arwin/python folder/food-delivery-cost-and-profitability-analysis/food_orders_new_delhi.csv")
...
# check if there are any null values in the dataset and replace them with 'None'
n = food_orders.isnull().sum()
# print(n)
food_orders['Discounts and Offers'] = food_orders['Discounts and Offers'].fillna('None')
n2 = food_orders.isnull().sum()
# print(n2)
...
# calculate the simulated commission fee and discount amount using the recommended percentages
